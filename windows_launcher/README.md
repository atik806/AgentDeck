...
| `workspace_sidebar.py` | The **WORKSPACES** list widget: switch, add, close, rename. Pure view — emits signals, touches no shell. Also owns the bottom nav strip (**Plugins**, **Notes**). |
